...
Assert-Contains $section '"id":"mobile_text"' 'The personalizer must expose a separate mobile description in the theme editor.'
Assert-Contains $section 'section.settings.mobile_text | default: section.settings.text' 'A blank mobile description must fall back to the desktop text.'
Assert-Contains $section '<p>{{ mobile_description }}</p>' 'The mobile image overlay must render the resolved mobile description.'
