...
Assert-Contains $featuredStyle '\.tilted-carousel__image\s*\{[^}]*background:\s*#f4f5f6;[^}]*border-radius:\s*0;' 'Handpicked cards must use the square collection media surface.'
